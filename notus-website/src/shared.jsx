...
export const NotusLogo = ({ size = 28, color = '#C15F3C' }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
    <path d="M6 26 L6 6 L10 6 L22 22 L22 6 L26 6 L26 26 L22 26 L10 10 L10 26 Z" fill={color}/>
    <circle cx="26" cy="6" r="2.5" fill={color} opacity="0.6"/>
  </svg>
);

export const useTypewriter = (text, speed = 30, startDelay = 0, deps = []) => {
...
export const MiniNotus = ({ variant = 'editor', dark = false }) => {
